...
public class Person {
    ...
    public Person(String firstName, String lastName, boolean telecommuter, double balance) {
        ...
        //
        //                @Override
        //                public void changed(javafx.beans.value.ObservableValue<? extends String> arg0, String ov, String nv) {
